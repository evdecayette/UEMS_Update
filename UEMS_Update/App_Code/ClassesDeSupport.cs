...
public class ReleveNotes
{
    ...
    // code update
    private List<EtudiantInfo> students = new List<EtudiantInfo>();

    public ReleveNotes(String unNomCours, String unNumeroCours)
    {
        NumeroCours = unNumeroCours;
        NomCours = unNomCours;
    }

    public void AddStudent(EtudiantInfo student)
    {
        students.Add(student);
    }

    public List<EtudiantInfo> GetEnrolledStudents()
    {
        return students;
    }
